    ...
    stages {
        ...
        stage('Deploy') {
            steps {
                ...
                sh "mv models/*  /var/www/node-app"
                sh "mv routes/*  /var/www/node-app"
                sh "mv .env  /var/www/node-app"
                sh "mv index.js  /var/www/node-app"
                sh "mv package.json  /var/www/node-app"
            }
        }
    }    
}